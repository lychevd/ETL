...
def run_ms_sql_no_data_out(ms_sql_params_out:MsSqlParamsOut,
    ...
    try:     # Associate program with pgp manager
        ...
        ms_sql_client.execute_query_autocommit(query_adjusted, "N")
...
def main():
    ...
    run_ms_sql_no_data_out(ms_sql_params_out, db_manager)
