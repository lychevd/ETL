    ...
    try:
        ...
        for item in file_list:
            ...
            try:
                ...
                if Ms_Sql_Params_IN.has_header=="Y":
                    output_file=local_temp_file+"_NO_HEADER"
                    local.remove_header_from_csv( local_temp_file, output_file)
                    local_temp_file=output_file
                if Ms_Sql_Params_IN.truncate_table=="Y":
                    truncate_statement="truncate table "+ Ms_Sql_Params_IN.ms_sql_database+"."+ Ms_Sql_Params_IN.ms_sql_schema+"."+Ms_Sql_Params_IN.ms_sql_table_in
                    ms_sql_client.execute_query_autocommit(truncate_statement,"N")
                ...
                number_of_records = ms_sql.import_data_file(Ms_Sql_Params_IN.ms_sql_server,
                                                            Ms_Sql_Params_IN.ms_sql_database,
                                                            Ms_Sql_Params_IN.ms_sql_table_in,
                                                            Ms_Sql_Params_IN.ms_sql_user,
                                                            Ms_Sql_Params_IN.ms_sql_password, local_temp_file,
                                                            Ms_Sql_Params_IN.data_file_delimiter,
                                                            int(Ms_Sql_Params_IN.ms_sql_port),
                                                            Ms_Sql_Params_IN.ms_sql_schema,
                                                            Ms_Sql_Params_IN.row_delimiter,
                                                            skip_header_rows
                                                            )
...
def main():
    ...
    Ms_Sql_Params_IN = MsSqlParamsIN(
        ...
        ms_sql_table_in=secrets.get_variable_value('ms_sql_table_in', variables, from_secret_list),
        ...
        has_header=secrets.get_variable_value( 'has_header', variables, from_secret_list),
        truncate_table=secrets.get_variable_value( 'truncate_table', variables, from_secret_list),
    ...
    if not files:
        ...
        sys.exit(0)
    try:
        load_gs_file_to_ms_sql(files, Gcs_File_Params, Ms_Sql_Params_IN, db_manager)
        db_manager.close_step_log(input_data.workflow_name, input_data.step_name, input_data.work_flow_log_id,
                                  Gcs_File_Params.work_flow_step_log_id, "success",
